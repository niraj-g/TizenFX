        ...
        public ReadOnlyCollection<ColorStop> ColorStops
        {
            ...
            set
            {
                ...
                for (int i = 0; i < value.Count; i++)
                {
                    ...
                    rawColorStops[i * 5 + 1] = value[i].GetColor().R;
                    rawColorStops[i * 5 + 2] = value[i].GetColor().G;
                    rawColorStops[i * 5 + 3] = value[i].GetColor().B;
                    rawColorStops[i * 5 + 4] = value[i].GetColor().A;
                }
